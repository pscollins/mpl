...
in
   ...
   val _ = let
      ...
      val _ = case PreFlatten.flattenOnce (PreFlatten.FlattenAlways, PreFlatten.DropAlias, PreFlatten.FlattenAnyType, PreFlatten.blockOnly, PreFlatten.noRecursiveFlatten, PreFlatten.FlattenAnyTransfer) p of
   ...
   val _ = let
      ...
      val p' = case PreFlatten.flattenOnce (PreFlatten.FlattenAlways, PreFlatten.DropAlias, PreFlatten.FlattenAnyType, PreFlatten.blockOnly, PreFlatten.noRecursiveFlatten, PreFlatten.FlattenAnyTransfer) p of
                  SOME p' => p'
